...
linhas do workspace A. Segue o protocolo de tests/integration/test_tenant_isolation.py (S1 —
...
Como rodar: ver cabeçalho de tests/integration/test_tenant_isolation.py.
"""
...
class TestCaminhoNovoV3:
    ...
    def test_refresh_e_load_escopados_por_workspace(self, two_tenants, monkeypatch):
        ...
        from radar.core.services.company_chunks import ensure_company_chunks, load_company_chunks
