...
def test_dispatch_review_sem_secao_lista_outline(monkeypatch):
    ...
    monkeypatch.setattr("core.services.writing_session.WritingSession",
                        lambda *a, **kw: session)
...
def test_dispatch_review_com_secao_chama_critic(monkeypatch):
    ...
    from core.llm.agent_tools.critic_agent import CriticResult
    ...
    monkeypatch.setattr("core.llm.agent_tools.critic_agent.run_critic", fake_critic)
...
def test_dispatch_review_nao_chama_set_section_content(monkeypatch):
    ...
    monkeypatch.setattr("core.llm.agent_tools.critic_agent.run_critic",
