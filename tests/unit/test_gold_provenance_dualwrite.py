...
class TestRequisitoResolution:
    ...
    def test_document_metadata_bundle_lineage_is_attached_when_unequivocal(self):
        blocks = [
            {
                "idx": 7,
                "doc": "pagina-oficial",
    ...
    def test_document_metadata_lineage_is_not_attached_when_ambiguous(self):
        blocks = [
            {
                "idx": 7,
                "doc": "pagina-oficial",
