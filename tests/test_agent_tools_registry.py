...
INTERNAL_ALLOWLIST: dict[str, str] = {
    ...
    # Tools de match (motor v3): lazy-importadas por explore_agent/writing_tools
    # SÓ quando há perfil (evita carregar match_v3/numpy no import do pacote) e
    # têm assinatura própria (profile_text, *, profile, workspace_id, db). Ficam
    # fora de __all__ de propósito, como build_critic_tools.
