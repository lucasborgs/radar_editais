...
do site usa internamente — ver `radar.pipeline.extractors.finep_api` para detalhes
...
from radar.core.kg.schema import iso_to_br_date
...
class FINEPScraper(BaseScraper):
    ...
    def _normalize(self, raw: dict) -> dict:
        """Converte um item cru da API Liferay para o shape legacy do radar.pipeline.
