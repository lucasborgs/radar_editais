...
`radar.core.llm.agent_runtime.run_agent` (que delega ao grafo LangGraph).
...
"""
from radar.core.llm.agent_tools.critic_agent import CriticResult, run_critic
...
from radar.core.llm.agent_tools.profile_tools import ExtractionState, build_profile_tools
...
from radar.core.llm.agent_tools.writing_tools import build_writing_tools
