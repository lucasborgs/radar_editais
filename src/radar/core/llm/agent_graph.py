...
from radar.core.llm.agent_runtime import (
    _FINALIZE_PROMPT,
    _LAST_STEP_PROMPT,
    _MAX_RETRIES,
    _TIMEOUT,
...
# (radar.core.retrieval.embedder, env-parametrizável) → zero token OpenAI quando
...
async def _init_memory_store():
    ...
    from radar.core.retrieval.embedder import EMBEDDING_DIMENSIONS
