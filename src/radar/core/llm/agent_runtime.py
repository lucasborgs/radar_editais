...
A lógica do loop ReAct vive em `radar.core.llm.agent_graph` (LangGraph StateGraph —
...
# Defaults compartilhados com radar.core.llm.llm_client (vide LLM_TIMEOUT_SECONDS / MAX_RETRIES).
...
# =============================================================================
# Entradas do agente — delegam ao grafo LangGraph (radar.core.llm.agent_graph)
# =============================================================================
...
async def run_agent_async(
    *,
    ...
    `radar.core.llm.agent_graph.run_agent_graph_async`.
...
async def run_agent_streaming_async(
    *,
    ...
    """
    from radar.core.llm.agent_graph import run_agent_graph_streaming
