...
from radar.core.infra.net_guard import safe_get
...
# registradas via radar.core.llm.agent_tools.build_profile_tools.
...
class ProfileExtractor:
    ...
    def _extract_agent(self, url: str) -> ExtractResult:
        ...
        from radar.core.llm.agent_tools import (
            ExtractionState,
            PlanState,
            Scratchpad,
    ...
    def extract_diff_from_message(
        ...
        `_call_diff_llm` resolve o modelo via `radar.core.infra.llm_router` no tier "fast".
        """
    ...
    def _call_diff_llm(self, message: str, current_profile: dict) -> dict | None:
        ...
        `radar.core.infra.llm_router.resolve_model("fast")` (gpt-4o-mini por default).
