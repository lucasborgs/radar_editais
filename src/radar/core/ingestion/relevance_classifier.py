...
_OPPORTUNITY_CLASSIFIER_SYSTEM = (
    ...
    "     Nesse caso, repita cada código X tanto em reason_codes quanto em "
    "exclusion_codes, e forneça uma evidence literal para cada código.\n"
    ...
    "Cada evidence.quote deve ser uma única substring copiada literalmente do material; "
    "não parafraseie nem junte trechos não contíguos.\n"
    "\n"
...
_INVESTOR_CLASSIFIER_SYSTEM = (
    ...
    "  - Cada evidence.quote deve ser uma única substring copiada literalmente do "
    "material; não parafraseie nem junte trechos não contíguos.\n"
    "\n"
    "Responda APENAS JSON válido, sem markdown, sem comentários:\n"
    '{\n'
    '  "decision": "in_scope|out_of_scope|needs_review",\n'
...
_AGENCY_CLASSIFIER_SYSTEM = (
    ...
    "  - Ausência de evidência não equivale a evidência de ausência. "
    "Nunca transforme informação ausente em failed_code.\n"
    "  - Uma agência pública brasileira ou atuação declarada em um estado brasileiro "
    "satisfaz AGY_BRAZIL_RELEVANCE quando sustentada por quote literal.\n"
    "  - Cada evidence.quote deve ser uma única substring copiada literalmente do "
    "material; não parafraseie nem junte trechos não contíguos.\n"
    "\n"
    "Responda APENAS JSON válido, sem markdown, sem comentários:\n"
