...
Langfuse é explícita. Entrypoint: `python -m radar.core.eval run <suite>` ou
`python -m radar.core.eval gate <suite>`.
"""
from radar.core.eval.harness import Criterion, Evaluation, Suite, run_suite
