...
def load_data() -> list[dict]:
    if not GOLDEN.exists():
        return []
    from radar.core.ingestion.edital_extractor import raw_by_native_id
...
def task(*, item: Any, **_) -> dict:
    inp = get_input(item)
    from radar.core.ingestion.edital_extractor import extract_edital
...
SUITE = Suite(
    ...
    manifest_config={
        ...
        "raw_source": "radar.core.ingestion.edital_extractor.raw_by_native_id",
    },
)
