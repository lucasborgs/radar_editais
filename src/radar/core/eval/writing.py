...
def task(*, item: Any, **_) -> dict:
    inp = get_input(item)
    from radar.core.eval.metrics_writing import (
    ...
    from radar.core.llm.agent_tools.critic_agent import _build_proposal_context
    from radar.core.retrieval.retriever import format_chunks_for_prompt, retrieve_chunks
