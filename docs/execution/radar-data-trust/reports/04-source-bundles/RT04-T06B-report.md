...
- Commits:
  - implementação: `9cf4d428c`
  - relatório: `<this commit>`
...
- `_save_fapesc_bundle_if_available()` passou a retornar o bundle somente quando a persistência foi confirmada;
