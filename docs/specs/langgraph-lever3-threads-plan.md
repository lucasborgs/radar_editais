...
| **T4 ESCRITA (1ª fatia)** | ✅ **implementada** (`dd382056e`,`574c3e532`,`e9135c173`) + **T4.1 precedência** (este commit). **NO-GO para MERGE** — paridade de `user_edit_preserved` NÃO restaurada (título 1/3 vs baseline 3/3; ver T4.1 abaixo). Reside na branch `feat/lever3-threads` |
