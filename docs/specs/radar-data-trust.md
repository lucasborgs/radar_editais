...
**Status:** vigente (specs 00–02 concluídas; spec 03 em especificação) · **Data:** 2026-07-26
...
| 03 | [`radar-data-trust-03-source-coverage.md`](radar-data-trust-03-source-coverage.md) | registro vivo, saúde, frescor e métricas de cobertura | 00 | proposta para aprovação |
