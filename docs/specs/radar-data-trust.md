...
**Status:** vigente (specs 00–03 concluídas; spec 04 proposta para aprovação) · **Data:** 2026-07-27
...
| 04 | [`radar-data-trust-04-source-bundles.md`](radar-data-trust-04-source-bundles.md) | documentos de oportunidades, retificações e páginas oficiais de atores versionados | 01; métricas de 02 | proposta para aprovação |
