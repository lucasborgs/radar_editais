...
| 3 | Operação da descoberta | [discovery-operations.md](discovery-operations.md) | em especificação | staging, tasks de promoção, ingest gold e RAG | promoção observável por etapa, reprocessável e auditável |
