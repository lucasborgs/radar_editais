...
| 2 | Urgência, filtros e comparação | [radar-fase-2.md](radar-fase-2.md) | em especificação | entrega 1 e contrato estável de cards | usuário filtra, prioriza por prazo e compara oportunidades sem reinterpretar ranking |
